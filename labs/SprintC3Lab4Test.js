...
describe("cookingStatus", () => {
  it("recognizes that there is time left on the timer", () => {
  ...
  it("recognizes when there is no time left on the timer", () => {
    expect(cookingStatus(0)).toBe("Lasagna is done.");
  });

  it("returns a special status when no timer value was passed", () => {
...
describe("preparationTime", () => {
  it("applies the custom average time per layer", () => {
    const manyLayers = [
      "sauce",
      "noodles",
      "béchamel",
  ...
  it("uses the default if no custom time was passed", () => {
    const manyLayers = [
      "sauce",
      "noodles",
      "béchamel",
  ...
  it("works with an empty layers array", () => {
    expect(preparationTime([])).toBe(0);
  });
});

describe("quantities", () => {
  it("calculates the amounts of noodles and sauce correctly", () => {
  ...
  it("works if there are no noodles or no sauce found in the layers", () => {
...
describe("addSecretIngredient", () => {
  it("adds the secret ingredient to the second array", () => {
  ...
  it("does not modify the first array", () => {
